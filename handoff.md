...
VM は比較後に 4 OCPU / 24 GB へ戻した。2/12は受入不合格だったため、2026-08-12のユーザー判断で本番ターゲットを4/24に確定した。これは無料トライアル中またはPAYG前提であり、トライアル終了前にPAYGへ移行して予算・使用量アラートを設定する。
