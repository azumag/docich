...
> 直前セッション: v738（4a3b4c7acdc2、06:32 反映）は n=13 で平均 1253（v736 窓 1681、−430、z≈1.6）、機構 KPI は良好（発火手の横隣接 42% vs 基準 14–16%、高型被覆は基準以下）。次 tick で n≥24 の早期停止判定（窓−500）。設計委任は fable。SOREN_SETTLE_REQUIRED=3。
