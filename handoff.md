...
> 直前セッション: v736 PROBABLE_MERGE_CONTACT（NO 盤面の接触着地加点、hash 253cc67e0c1b）を opus レビュー通過後 00:15 に VM 反映（revert 先 v734）、初戦監視中。静止待ち実験は締め（REQUIRED=1 n=20 平均 1380 → REQUIRED=3 n=54 平均 1564）、SOREN_SETTLE_REQUIRED=3 維持。v736 判定窓では SOREN_SETTLE_* を変更しない。
