...
class ShadowOnceTests(unittest.TestCase):
 ...
 def test_bootstrap_checks_mode_and_never_calls_normal_spawner(self):
  ...
  self.assertIn('MODEL_IMPROVE_LIST=opencode-go:muse-spark-1.3-contributor,opencode-go:muse-spark-1.2-contributor,opencode:mimo-v2.6-flash-free,opencode-go:mimo-v2.6-flash,opencode-go:deepseek-v4-flash',s)
