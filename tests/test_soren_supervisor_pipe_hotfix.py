...
SCRIPT = Path(__file__).resolve().parents[1] / "ops" / "hotfixes" / "apply_soren_supervisor_pipe_hotfix.py"
...
def test_cli_is_production_path_only():
    assert hotfix.TARGET == Path("/home/ubuntu/soren/start_all.sh")
    assert hotfix.OLD_SHA256 == "ae87c7e2e47be74cfdd5f8fcc1a7749a747b95a75ee5731468e8a67681616830"
    assert hotfix.NEW_SHA256 == "90580eee5d5c21708b6314a026570a4281617bffb63af633a95424738b155af7"
    assert hotfix.SOURCE_COMMIT == "4be20e3cd4e1028f9e034d1e4e7b9b02907cf481"
