...
async function saveTwitchAds(){
  ...
  try{
    const res=await api("/api/config",{method:"PUT",headers:{"Content-Type":"application/json"},body:JSON.stringify({values:{TWITCH_ADS_ENABLED:value},expected_mtime:ENV_MTIME})});
