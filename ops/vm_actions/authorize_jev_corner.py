#!/usr/bin/env python3
"""Fail-closed authorization for the fixed owner-only JEV corner operator."""
...
OPERATIONS = {"start", "finish", "status", "recover", "diagnose", "recover-diagnose", "refresh-bridge", "recover-bridge"}
...
def main() -> None:
    ...
    if not all(checks):
        fail("JEV corner authorization denied")
    ...
    if operation not in OPERATIONS:
        fail("unsupported JEV corner operation")
